    ...
    <div class=' h-[50vh]  flex justify-center'>
      <div class='flex  w-full flex-col items-center'>
        ...
        <div class='w-[40rem] flex flex-col items-center'>
          ...
          {usr?.username === '' ? (
            <h6 class='text-custom_gray mb-[1rem] font-medium'>@username</h6>
          ) : (
            <h6 class='text-custom_gray mb-[1rem] font-medium'>@{usr?.displayName}</h6>
          )}
          <div class='flex'>
            <p class='leading-normal mb-[1rem] font-regular mr-[10px]'>{usr?.website}</p> ·{' '}
            <p class='leading-normal mb-[1rem] font-regular ml-[10px]'>{usr?.tagline}</p>
          </div>
        </div>
